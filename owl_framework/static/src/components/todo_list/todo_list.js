...
export class OwlTodoList extends Component {
    setup(){
        this.state = useState({
            task:{name:"", color:"#FFFF00", completed:false},
            taskList:[],
            isEdit: false,
            activeId: false,
        })
...
OwlTodoList.template = 'owl_framework.TodoList'

registry.category('actions').add('owl_framework.action_todo_list_js', OwlTodoList);

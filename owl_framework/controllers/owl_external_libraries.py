...
class OwlExternalLibraries(http.Controller):
    @http.route('/filepond/process', type='http', auth='user', method=["POST"], csrf=False)
    ...
    @http.route('/filepond/revert', type='http', auth='user', method=["DELETE"], csrf=False)
